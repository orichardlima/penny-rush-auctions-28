...
const faqs = [
  {
    ...
    answer: "Não. O programa de parceiros não é um investimento financeiro regulamentado. É uma parceria onde você contribui com um aporte e recebe repasses proporcionais baseados no desempenho da plataforma. Não há garantia de rentabilidade ou retorno."
  },
  {
    question: "Como são calculados os repasses?",
    answer: "Os repasses são calculados de forma proporcional. Pegamos uma porcentagem da receita mensal da plataforma e distribuímos entre todos os parceiros ativos, proporcionalmente ao valor do aporte de cada um em relação ao fundo total."
  },
  {
  ...
  {
    question: "Qual a frequência dos repasses?",
    answer: "Os repasses são calculados e creditados mensalmente, sempre na primeira semana do mês seguinte ao período de apuração. Você pode acompanhar tudo pelo dashboard."
  },
  {
    question: "O que acontece se a plataforma não performar bem?",
    answer: "Os repasses dependem do desempenho da plataforma. Em meses de baixo desempenho, os repasses serão proporcionalmente menores. Não há garantia de valor mínimo mensal."
  },
  {
  ...
  },
  {
    ...
    answer: "Não há garantia de retorno. Os repasses dependem exclusivamente do desempenho da plataforma. O teto define o máximo que você pode receber, não o que você vai receber."
  }
];
