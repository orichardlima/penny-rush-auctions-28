    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-background via-secondary/5 to-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          <TabsList className={`grid w-full ${isManager ? 'grid-cols-7' : 'grid-cols-6'} lg:w-auto lg:inline-grid`}>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  ...
                  />
                  <Button onClick={copyAffiliateLink} variant="outline" size="icon" disabled={partnerFinancialStatus !== 'paid'}>
                    <Copy className="h-4 w-4" />
                  </Button>
                  <Button onClick={shareAffiliateLink} variant="outline" size="icon" disabled={partnerFinancialStatus !== 'paid'}>
                    <Share2 className="h-4 w-4" />
                  </Button>
                  {partnerFinancialStatus === 'paid' && (
                    <QRCodeModal 
