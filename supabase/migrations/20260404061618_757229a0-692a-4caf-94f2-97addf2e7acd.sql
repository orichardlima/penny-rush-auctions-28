...
-- 1. Adicionar coluna finish_reason
ALTER TABLE auctions ADD COLUMN IF NOT EXISTS finish_reason text;

-- 2. Recriar bot_protection_loop com atomicidade, finish_reason e safety net 60s
...
BEGIN
  ...
  LOOP
    ...
    -- =============================================
    -- SAFETY NET: FINALIZAÇÃO POR INATIVIDADE (60s+)
    -- =============================================
