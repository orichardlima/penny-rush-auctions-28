...
CREATE TABLE public.bot_webhook_logs (
...
CREATE INDEX idx_bot_webhook_logs_auction_created_at 
  ON public.bot_webhook_logs (auction_id, created_at DESC);

-- Admins can view all logs
CREATE POLICY "Admins can view bot webhook logs"
...
CREATE POLICY "Admins can insert bot webhook logs"
ON public.bot_webhook_logs
FOR INSERT
WITH CHECK (
  EXISTS (
