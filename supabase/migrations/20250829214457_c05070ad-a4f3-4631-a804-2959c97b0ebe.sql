-- CORREÇÃO URGENTE DO SISTEMA DE LEILÕES
...
-- Log da correção
RAISE LOG '🚨 [CORREÇÃO-URGENTE] Sistema de leilões corrigido: cron jobs limpos, funções removidas, leilões resetados às %', timezone('America/Sao_Paulo', now());